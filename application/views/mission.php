    ...
    <div class="container section ">
        ...
        <div class=" row" style="display:flex !important;    align-items: center;    justify-content: space-between;">
            ...
            <div class=" col-md-5 col-sm-12 tc">
                ...
                <p>Our Big Audacious Goal <span class="bold">(B.A.G)</span> is to be the largest <span
                        class="bold">community</span> of the EV Industry. We will be the go-to-marketplace for all the
